...
CONTROL_CHANNEL_ID = os.getenv("CONTROL_CHANNEL_ID", None)
CONTROL_CHANNEL_NAME = os.getenv("CONTROL_CHANNEL_NAME", 'bot-control')

LIVE_CHANNEL_ID = os.getenv("LIVE_CHANNEL_ID", None)
LIVE_CHANNEL_NAME = os.getenv("LIVE_CHANNEL_NAME", None)
